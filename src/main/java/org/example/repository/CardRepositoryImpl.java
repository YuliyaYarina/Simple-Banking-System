 ...
 * Хранит данные аккаунтов в SQLite и управляет базовыми CRUD-операциями.
 */
public class CardRepositoryImpl implements CardRepository {

    private static final String DEFAULT_DB_NAME = "bankingCards.db";
     ...
     */
    @Override
    public void updatedCard(String numberCard, String pin) {
